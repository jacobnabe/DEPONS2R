...
#' finished. This is read from the name of the input file.
...
#' @details The \code{dyn} slot contains a data frame with a column 'tick',
...
#' animals were counted; and a column 'count' with the number of animals in that block
...
#' @param fname Character. Name of the file that contains movement data
...
#' @param landscape Optional character string giving name of the landscape used
#' in the simulation
#' @param simtime Optional date and time when the simulation finished (character
#' string of the form 'yyyy-mm-dd hh:mm:ss', or POSIXlt). If not provided this
#' is obtained from name of input file
#' @param timestep Numerical. Time step used in the model, in minutes. Default 30 minutes
